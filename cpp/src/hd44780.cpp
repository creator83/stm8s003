...
{
  d4.setOutPin (hd44780Def::d4pin);
  d5.setOutPin (hd44780Def::d5pin);
  d6.setOutPin (hd44780Def::d6pin);
  d7.setOutPin (hd44780Def::d7pin);
  e.setOutPin (hd44780Def::epin);
  rs.setOutPin (hd44780Def::rspin);
  rw.setOutPin (hd44780Def::rwpin);
  d[0] = &d4;
  d[1] = &d5;
  d[2] = &d6;
  d[3] = &d7;
